...
public class ExampleOperator_WrappedExecutable extends ToolkitOperator {
	/*
	...
	public ExampleOperator_WrappedExecutable(String datasetURL) {
	...
	public String transform(String param1, String param2, String param3){
		...
		/************* Configure the call to the executable below ***************/
		// you can pass this file to scripts if needed by using the following pattern:		
		String cmd = 
			"executable-name "
			+ inputPath + " "
			+ outputPath + " "
